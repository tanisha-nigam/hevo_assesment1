...
3.	Created a virtual warehouse (COMPUTE_WH).
  
5.	Verified access to Snowflake Worksheets.
...
3.	Navigated to Partner Connect.
   
5.	Selected Hevo Data and created a free trial account.
   
7.	Verified Hevo account activation and region (Asia – Singapore).
...
3. Customers → Username Derivation
